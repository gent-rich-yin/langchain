...
if __name__ == '__main__':
    ...
    db = SQLDatabase.from_uri("postgresql://admin:quest@127.0.0.1:8812/qdb")
    ...
    gr.ChatInterface(
        ...
        type="messages",
        title="RichBot",
        description="A simple bot that can answer questions on Bitcoin and Nasdaq trades by querying QuestDB database.",
